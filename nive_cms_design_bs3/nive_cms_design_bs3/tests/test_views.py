...
from nive_cms_design_bs3.view import *
...
class tDesign(object):
    ...
    def setUp(self):
        ...
        self._loadApp(["nive_cms_design_bs3.view"])
    ...
    def test_templates(self):
        ...
        render("nive_cms_design_bs3:templates/box.pt", {"context":b1, "view":view})
        b2 = create_column(self.page, user)
        render("nive_cms_design_bs3:templates/column.pt", {"context":b2, "view":view})
        b3 = create_file(self.page, user)
        render("nive_cms_design_bs3:templates/file.pt", {"context":b3, "view":view})
        b4 = create_image(self.page, user)
        render("nive_cms_design_bs3:templates/image.pt", {"context":b4, "view":view})
        b5 = create_media(self.page, user)
        render("nive_cms_design_bs3:templates/media.pt", {"context":b5, "view":view})
        b6 = create_note(self.page, user)
        render("nive_cms_design_bs3:templates/note.pt", {"context":b6, "view":view})
        b7 = create_text(self.page, user)
        render("nive_cms_design_bs3:templates/text.pt", {"context":b7, "view":view})
        b8 = create_spacer(self.page, user)
        render("nive_cms_design_bs3:templates/spacer.pt", {"context":b8, "view":view})
        b9 = create_link(self.page, user)
        render("nive_cms_design_bs3:templates/link.pt", {"context":b9, "view":view})
        b0 = create_menublock(self.page, user)
        render("nive_cms_design_bs3:templates/menublock.pt", {"context":b0, "view":view, "request": self.request})
        b10 = create_code(self.page, user)
        render("nive_cms_design_bs3:templates/code.pt", {"context":b10, "view":view})
        b11 = create_news(self.page, user)
        render("nive_cms_design_bs3:templates/news.pt", {"context":b11, "view":view})
        ...
        render("nive_cms_design_bs3:templates/page.pt", {"context":self.page, "view":view, "cmsview":None})
        render("nive_cms_design_bs3:templates/root.pt", {"context":self.page.dataroot, "view":view, "cmsview":None})
        r=view.view()
